...
const en: Record<string, string> = {
  ...
  "translate.standardDesc": "Stable & voice cloning",
  "translate.beta": "Beta",
  "translate.betaDesc": "Low latency AI",
  "translate.cannotSwitchEngines": "Cannot switch engines during an active session",
  "translate.voiceClone.title": "Sound like yourself",
  "translate.voiceClone.desc": "Set up voice cloning so your translations sound like you, not a robot.",
  "translate.voiceClone.setupLink": "Set up voice clone →",
  "translate.betaEngine.title": "Beta Engine",
  "translate.betaEngine.desc": "Uses low-latency speech-to-speech AI. Single connection, faster response. Voice cloning is not available in this mode.",
...
const ar: Record<string, string> = {
  ...
  "translate.engine": "محرك الترجمة",
  "translate.standard": "قياسي",
  "translate.standardDesc": "مستقر ونسخ الصوت",
  "translate.beta": "تجريبي",
  "translate.betaDesc": "ذكاء اصطناعي منخفض التأخير",
  "translate.cannotSwitchEngines": "لا يمكن تبديل المحركات أثناء جلسة نشطة",
  "translate.voiceClone.title": "استخدم صوتك الحقيقي",
  "translate.voiceClone.desc": "قم بإعداد نسخ الصوت لتبدو ترجماتك مثلك، وليس مثل الروبوت.",
  "translate.voiceClone.setupLink": "إعداد نسخ الصوت ←",
  "translate.betaEngine.title": "المحرك التجريبي",
  "translate.betaEngine.desc": "يستخدم الذكاء الاصطناعي للكلام إلى الكلام منخفض التأخير. اتصال واحد، استجابة أسرع. نسخ الصوت غير متاح في هذا الوضع.",
